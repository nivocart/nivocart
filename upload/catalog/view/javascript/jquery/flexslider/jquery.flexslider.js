 ...
 *
 * Version 2.7.2 for NivoCart | @nivocart
 */
(function($) {
	var focused = true;
	...
	$.flexslider = function(el, options) {
		...
		var namespace = slider.vars.namespace,
			...
			// Note: deprecating this idea, as devices are being released with both of these events
	...
	slider.setup = function(type) {
		...
		slider.addSlide = function(obj, pos) {
			...
			// Re-setup the slider to accomodate new slide
			slider.setup();
