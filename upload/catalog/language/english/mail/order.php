...
$_['text_new_ccr_heading']      = 'Your Right to Cancel';
$_['text_new_ccr_notice']       = 'Under the Consumer Contracts Regulations 2013, you have the right to cancel this order within 14 days of receiving your goods, without giving a reason. You do not need to provide a reason for cancellation.';
$_['text_new_ccr_deadline']     = 'Cancellation deadline:';
$_['text_new_ccr_link']         = 'To submit a return or cancellation request, please visit:';
$_['text_new_powered']          = 'Powered by <a onclick="window.open(\'https://github.com/nivocart/nivocart\');">NivoCart</a>';
