...
class ModelCheckoutVoucher extends Model {
	...
	public function getVoucher($code) {
		...
		if ($voucher_query->num_rows) {
			...
			$voucher_history_query = $this->db->query("SELECT SUM(amount) AS `total` FROM " . DB_PREFIX . "voucher_history WHERE voucher_id = '" . (int)$voucher_query->row['voucher_id'] . "' GROUP BY voucher_id");
