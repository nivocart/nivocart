	...
	public function getQuote($address) {
		...
		foreach ($query->rows as $result) {
			...
			if ($status) {
				...
				if ((string)$cost != '') {
					$quote_data['airmail_' . $result['geo_zone_id']] = [
						...
						'text'         => $this->currency->format($this->tax->calculate($cost, $this->config->get('airmail_tax_class_id'), $this->config->get('config_tax')), $this->config->get('config_currency'))
					];
				}
			}
		}
