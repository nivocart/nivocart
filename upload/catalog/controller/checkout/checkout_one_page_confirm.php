 ...
 * Called after checkout_one_page validates and stores order data in session.
 * Builds totals, calls addOrder(), calls payment gateway confirm() directly,
 * then redirects to checkout/success. The customer never sees this page.
 */
class ControllerCheckoutCheckoutOnePageConfirm extends Controller {
	/** Error array Placeholder */

	public function index() {
		// Guard — must have session data from checkout_one_page
		...
		// Confirm the order via the payment gateway directly
