...
class ControllerSettingSetting extends Controller {
	...
	private const LANG_KEYS = [
		...
		'entry_catalog_limit', 'entry_dashboard_map', 'entry_pagination_hi', 'entry_pagination_lo',
		'entry_auto_seo_url', 'entry_user_group_display',
		'entry_catalog_barcode', 'entry_admin_barcode', 'entry_barcode_type',
		'entry_buy_now', 'entry_lightbox', 'entry_share_sharethis',
		'entry_price_free', 'entry_price_hide', 'entry_hide_mini_label', 'entry_cookie_consent',
		...
		'entry_image_wide_thumb', 'entry_image_popup', 'entry_image_product', 'entry_image_additional',
		...
		'help_dashboard_map', 'help_pagination_hi', 'help_pagination_lo', 'help_auto_seo_url',
		...
		'help_price_hide', 'help_hide_mini_label', 'help_cookie_privacy', 'help_cookie_age',
		...
		'help_image_wide_thumb', 'help_image_popup', 'help_image_product', 'help_image_additional',
	...
	private const CONFIG_DEFAULTS = [
		...
		'config_voucher_max'      => [],
		// Preference
		'config_dashboard_map'    => ['default' => 'world_en'],
		...
		'config_image_wide_thumb_width' => [], 'config_image_wide_thumb_height' => [],
	...
	private const ERROR_KEYS = [
		...
		'image_wide_thumb', 'image_popup', 'image_product', 'image_additional', 'image_brand',
	...
	private function validateImage(): void {
		...
		foreach ([
			'image_category', 'image_thumb', 'image_wide_thumb', 'image_popup', 'image_product',
