...
class ControllerCommonHeader extends Controller {
	...
	protected function index() {
		...
		$this->data['text_blog_comment'] = $this->language->get('text_blog_comment');
		$this->data['text_blog_report'] = $this->language->get('text_blog_report');
		$this->data['text_blog_views'] = $this->language->get('text_blog_views');
		...
		$this->data['text_email_manager'] = $this->language->get('text_email_manager');
		...
		$this->data['text_nivocart'] = $this->language->get('text_nivocart');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] !== $this->session->data['token'])) {
			...
			$this->data['license'] = $this->url->link('tool/license', 'token=' . $this->session->data['token'], 'SSL');
