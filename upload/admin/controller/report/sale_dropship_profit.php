...
class ControllerReportSaleDropshipProfit extends Controller {
    ...
    public function index(): void {
        ...
        $this->data['total_gross_margin']  = ($total_revenue > 0)
            ? number_format(($total_gross / $total_revenue) * 100, 2) . '%'
            : '0.00%';
        ...
        if (!$has_cost_config) {
            ...
            $this->data['text_no_cost_config'] = sprintf(
                $this->language->get('text_no_cost_config'),
                $config_url
            );
        }
        ...
        $pagination->url    = $this->url->link('report/sale_dropship_profit',
