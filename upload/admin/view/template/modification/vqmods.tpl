...
<div class="box">
  ...
  <div class="content">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="vqmod">
      <div id="tab-list">
        <table class="list">
          <thead>
            <tr>
...
$(document).ready(function() {
	...
	// Confirm vqmod_nivocart.xml Uninstall
	$('a').click(function() {
		if ($(this).attr('href') != null && $(this).attr('href').indexOf('vqmod_nivocart', 1) != -1 && $(this).attr('href').indexOf('uninstall', 1) != -1) {
	...
	// Confirm vqmod_nivocart.xml Delete
	$('a').click(function() {
		if ($(this).attr('href') != null && $(this).attr('href').indexOf('vqmod_nivocart', 1) != -1 && $(this).attr('href').indexOf('delete', 1) != -1) {
