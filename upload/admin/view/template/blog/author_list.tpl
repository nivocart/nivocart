      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <thead>
          <tr>
            ...
            <td class="left"><?php if ($sort == 'ba.name') { ?>
              <a href="<?php echo $sort_name; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_author_name; ?></a>
            <?php } else { ?>
              <a href="<?php echo $sort_name; ?>"><?php echo $column_author_name; ?>&nbsp;&nbsp;<img src="view/image/sort.png" alt="" /></a>
            <?php } ?></td>
            <td class="left"><?php if ($sort == 'ba.status') { ?>
        ...
        <?php foreach($authors as $author) { ?>
          <tr>
            <td style="text-align:center;"><?php if ($author['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $author['blog_author_id']; ?>" id="<?php echo $author['blog_author_id']; ?>" class="checkbox" checked />
              <label for="<?php echo $author['blog_author_id']; ?>"><span></span></label>
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $author['blog_author_id']; ?>" id="<?php echo $author['blog_author_id']; ?>" class="checkbox" />
              <label for="<?php echo $author['blog_author_id']; ?>"><span></span></label>
            <?php } ?></td>
            ...
            <?php } ?>
            <td class="center"><?php echo $author['date_added']; ?></td>
            <td class="right">
