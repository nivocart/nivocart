      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <thead>
          <tr>
            ...
            <?php } ?></td>
            <td class="left"><?php if ($sort == 'ba.sort_order') { ?>
              <a href="<?php echo $sort_sortorder; ?>" class="<?php echo strtolower($order); ?>"><?php echo $column_sort_order; ?></a>
            <?php } else { ?>
              <a href="<?php echo $sort_sortorder; ?>"><?php echo $column_sort_order; ?>&nbsp;&nbsp;<img src="view/image/sort.png" alt="" /></a>
            <?php } ?></td>
        ...
        <?php foreach ($articles as $article) { ?>
          <tr>
            <td style="text-align:center;"><?php if ($article['selected']) { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $article['blog_article_id']; ?>" id="<?php echo $article['blog_article_id']; ?>" class="checkbox" checked />
              <label for="<?php echo $article['blog_article_id']; ?>"><span></span></label>
            <?php } else { ?>
              <input type="checkbox" name="selected[]" value="<?php echo $article['blog_article_id']; ?>" id="<?php echo $article['blog_article_id']; ?>" class="checkbox" />
              <label for="<?php echo $article['blog_article_id']; ?>"><span></span></label>
            <?php } ?></td>
