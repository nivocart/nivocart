...
$('input[name=\'menu_horizontal_theme\']').on('change', function() {
	$('.menu-theme').hide();
...
function addModule() {
	...
	html += '    </select></td>';
	html += '    <td class="center"><input type="text" name="menu_horizontal_module[' + module_row + '][sort_order]" value="0" size="3" /></td>';
