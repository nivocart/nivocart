      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="viewed">
        ...
        <tbody>
          ...
          <tr class="highlighted">
            ...
            <td><?php if ($viewed_show_mini_label) { ?>
              <input type="radio" name="viewed_show_mini_label" value="1" id="show_mini_label-on" class="radio" checked />
              <label for="show_mini_label-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="viewed_show_mini_label" value="0" id="show_mini_label-off" class="radio" />
              <label for="show_mini_label-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="viewed_show_mini_label" value="1" id="show_mini_label-on" class="radio" />
              <label for="show_mini_label-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="viewed_show_mini_label" value="0" id="show_mini_label-off" class="radio" checked />
              <label for="show_mini_label-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
        </tbody>
...
function addModule() {
	...
	html += '      <input type="text" name="viewed_module[' + module_row + '][image_height]" value="150" size="3" /> px';
	html += '    </td>';
	...
	html += '    </select></td>';
	html += '    <td class="center"><input type="text" name="viewed_module[' + module_row + '][sort_order]" value="0" size="3" /></td>';
