      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="special">
        ...
        <tbody>
          ...
          <tr class="highlighted">
            ...
            <td><?php if ($special_show_mini_label) { ?>
              <input type="radio" name="special_show_mini_label" value="1" id="show_mini_label-on" class="radio" checked />
              <label for="show_mini_label-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="special_show_mini_label" value="0" id="show_mini_label-off" class="radio" />
              <label for="show_mini_label-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="special_show_mini_label" value="1" id="show_mini_label-on" class="radio" />
              <label for="show_mini_label-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="special_show_mini_label" value="0" id="show_mini_label-off" class="radio" checked />
              <label for="show_mini_label-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
        </tbody>
        ...
        <?php foreach ($modules as $module) { ?>
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><select name="special_module[<?php echo $module_row; ?>][style]">
              ...
              <td class="left">
                <input type="text" name="special_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="1" />
              </td>
              <td class="left">
...
function addModule() {
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="special_module[' + module_row + '][style]">';
