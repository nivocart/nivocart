      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="blog_category">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php if ($blog_category_theme) { ?>
              <input type="radio" name="blog_category_theme" value="1" id="theme-on" class="radio" checked />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="blog_category_theme" value="0" id="theme-off" class="radio" />
              <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } else { ?>
              <input type="radio" name="blog_category_theme" value="1" id="theme-on" class="radio" />
              <label for="theme-on"><span><span></span></span><?php echo $text_yes; ?></label>
              <input type="radio" name="blog_category_theme" value="0" id="theme-off" class="radio" checked />
              <label for="theme-off"><span><span></span></span><?php echo $text_no; ?></label>
            <?php } ?></td>
          </tr>
          <tr>
            ...
            <td><?php foreach ($languages as $language) { ?>
              <input type="text" name="blog_category_title<?php echo $language['language_id']; ?>" id="blog_category_title<?php echo $language['language_id']; ?>" size="30" value="<?php echo ${'blog_category_title' . $language['language_id']}; ?>" />
        ...
        <?php foreach ($modules as $module) { ?>
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><select name="blog_category_module[<?php echo $module_row; ?>][layout_id]">
              ...
              <td class="left"><select name="blog_category_module[<?php echo $module_row; ?>][position]">
              ...
              <td class="left"><select name="blog_category_module[<?php echo $module_row; ?>][status]">
              ...
              <td class="center">
                <input type="text" name="blog_category_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" />
              </td>
              <td class="center">
...
function addModule() {
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="blog_category_module[' + module_row + '][layout_id]">';
	<?php foreach ($layouts as $layout) { ?>
	html += '      <option value="<?php echo $layout['layout_id']; ?>"><?php echo addslashes($layout['name']); ?></option>';
	<?php } ?>
	html += '    </select></td>';
	html += '    <td class="left"><select name="blog_category_module[' + module_row + '][position]">';
	...
	html += '    </select></td>';
	html += '    <td class="left"><select name="blog_category_module[' + module_row + '][status]">';
	html += '      <option value="1" selected="selected"><?php echo $text_enabled; ?></option>';
	html += '      <option value="0"><?php echo $text_disabled; ?></option>';
	html += '    </select></td>';
	html += '    <td class="center"><input type="text" name="blog_category_module[' + module_row + '][sort_order]" value="0" size="3" /></td>';
