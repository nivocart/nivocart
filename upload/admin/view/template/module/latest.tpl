      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" name="latest">
        ...
        <?php foreach ($modules as $module) { ?>
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="left"><select name="latest_module[<?php echo $module_row; ?>][style]">
              ...
              <td class="left">
                <input type="text" name="latest_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" size="1" />
              </td>
              <td class="left">
...
function addModule() {
	...
	html += '  <tr>';
	html += '    <td class="left"><select name="latest_module[' + module_row + '][style]">';
	...
	html += '    <td class="left">';
	html += '      <input type="text" name="latest_module[' + module_row + '][image_width]" value="150" size="3" /> x ';
	html += '      <input type="text" name="latest_module[' + module_row + '][image_height]" value="150" size="3" /> px';
	html += '    </td>';
	...
	html += '    </select></td>';
	html += '    <td class="center"><input type="text" name="latest_module[' + module_row + '][sort_order]" value="0" size="3" /></td>';
