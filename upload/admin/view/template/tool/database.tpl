      ...
      <form action="<?php echo $database; ?>" method="post" enctype="multipart/form-data" id="form" name="database">
        ...
        <table class="tool">
          <tr>
            ...
            <td width="25%">
              <a onclick="Optimize();" class="button-save animated fadeIn ripple" style="min-width:55px;"><?php echo $button_optimize; ?></a>
            </td>
          </tr>
        </table>
        ...
        <table class="tool">
          <tr>
            ...
            <td width="25%">
              <a onclick="Repair();" class="button-repair animated fadeIn ripple" style="min-width:55px;"><?php echo $button_repair; ?></a>
            </td>
          </tr>
        </table>
        ...
        <table class="tool">
          ...
          <?php if (!$engine) { ?>
            ...
            <td width="25%"><a onclick="Innodb();" class="button-cancel animated fadeIn ripple" style="min-width:55px;"><?php echo $button_innodb; ?></a></td>
          <?php } else { ?>
            <td width="55%"><?php echo $text_help_innodb; ?></td>
            <td width="25%"><a onclick="Myisam();" class="button-cancel animated fadeIn ripple" style="min-width:55px;"><?php echo $button_myisam; ?></a></td>
          <?php } ?>
          </tr>
        </table>
