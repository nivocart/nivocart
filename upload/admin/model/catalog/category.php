...
class ModelCatalogCategory extends Model {
	...
	public function getCategoryImage(int $category_id) {
	...
	public function getListCategories(array $data = []): array {
	...
	public function getTotalCategoriesByImageId(int $image_id): int {
