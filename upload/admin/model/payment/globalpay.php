...
class ModelPaymentGlobalpay extends Model {
	...
	public function updateForRebate(int $globalpay_order_id, $pas_ref, $order_ref): void {
	...
	public function addTransaction(int $globalpay_order_id, $type, $total): void {
	...
	public function getTotalCaptured(int $globalpay_order_id) {
	...
	public function getTotalRebated(int $globalpay_order_id) {
