...
$_['error_vqmod_nivocart']             = 'Warning: "vqmod_nivocart.xml" is required for VQMod to function properly!';
...
$_['error_nivocart_version']           = 'NivoCart 1.0.0 or later is required to use VQmods!';
$_['error_nivocart_xml']               = 'Required file "<span class="error-install">/vqmod/xml/vqmod_nivocart.xml</span>" does not appear to exist! <br />Please install the latest NivoCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
$_['error_nivocart_xml_disabled']      = 'Warning: "<span class="error-install">vqmod_nivocart.xml</span>" is disabled! VQmod scripts will not function!';
$_['error_nivocart_xml_version']       = 'You appear to be using a version of "<span class="error-install">vqmod_nivocart.xml</span>" that is out-of-date for your NivoCart version! <br />Please install the latest NivoCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
$_['error_vqcache_dir']                = 'Required directory "<span class="error-install">/vqmod/vqcache</span>" does not appear to exist! <br /><br />Please install the latest NivoCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a>';
...
$_['error_vqmod_core']                 = 'Required file "<span class="error-install">vqmod.php</span>" is missing! <br />Please install the latest NivoCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
$_['error_vqmod_dir']                  = 'The "<span class="error-install">/vqmod</span>" directory does not appear to exist!';
$_['error_vqmod_install_link']         = '<b>VQMod&#8482; does not appear to have been integrated with NivoCart!</b> <br /><br />Please run the VQmod installer: <a href="%1$s" class="button-repair">INSTALL</a><br />';
$_['error_vqmod_nivocart_integration'] = '<b>VQMod&#8482; does not appear to have been integrated with NivoCart!</b> <br /><br />Please install the latest NivoCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
$_['error_vqmod_script_dir']           = 'Required directory "<span class="error-install">/vqmod/xml</span>" does not appear to exist! <br />Please install the latest NivoCart-compatible version of VQMod from <a onclick="window.open(\'https://github.com/vqmod/vqmod/releases\');" class="button">Latest VQMod</a> and try again.';
...
$_['vqmod_version']                    = 'v2.5.1';
$_['vqmod_author']                     = 'Qphoria (qphoria@gmail.com) & Jay Gilford (jay@jaygilford.com)';
$_['vqmod_license']                    = 'GPLv3 (GNU General Public License)';

// Javascript Warnings
$_['warning_required_delete']          = 'WARNING: Deleting \\\'vqmod_nivocart.xml\\\' will cause VQMod to STOP WORKING!  Continue?';
$_['warning_required_uninstall']       = 'WARNING: Uninstalling \\\'vqmod_nivocart.xml\\\' will cause VQMod to STOP WORKING!  Continue?';
