...
$_['text_help_innodb']      = 'Current Engine: <b>InnoDB</b> (Default)<span class="help">Click to convert the database table engine to MyISAM.</span>';
$_['text_help_myisam']      = 'Current Engine: <b>MyISAM</b><span class="help">Click to convert the database table engine to InnoDB.</span>';
