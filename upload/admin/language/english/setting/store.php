...
$_['entry_image_thumb']            = 'Normal Desktop Thumb Size:';
$_['entry_image_wide_thumb']       = 'Wide Screen Thumb Size:';
$_['entry_image_popup']            = 'Product Image Popup Size:';
$_['entry_image_product']          = 'Product Image List Size:';
$_['entry_image_additional']       = 'Product Additional Image Size:';
...
$_['help_image_thumb']             = 'Product Main image Normal display size.<br />Used when site width is Normal (1267px). Default 320 x 320px';
$_['help_image_wide_thumb']        = 'Product Main image Wide display size.<br />Used when site width is Wide or Unlimited. Default 520 x 520px';
$_['help_image_popup']             = 'Product Popup image on Product pages.<br />Default size 600 x 600px';
$_['help_image_product']           = 'Product images on Category, Search, Special, Reviews and other Product pages.<br />Default size 120 x 120px';
$_['help_image_additional']        = 'Product additional images on Product pages.<br />Default size 70 x 70px';
$_['help_image_category']          = 'Category image on Category pages.<br />Default size 100 x 100px';
$_['help_image_brand']             = 'Manufacturer image on Manufacturer pages.<br />Default size 80 x 80px';
$_['help_image_related']           = 'Related Product images on Product pages.<br />Default size 80 x 80px';
$_['help_image_compare']           = 'Product image on product Compare pages.<br />Default size 90 x 90px';
$_['help_image_wishlist']          = 'Product image on customer Wish List pages.<br />Default size 47 x 47px';
$_['help_image_newsthumb']         = 'News Main image on news pages.<br />Default size 200 x 200px';
$_['help_image_newspopup']         = 'News Popup image on news pages.<br />Default size 500 x 500px';
$_['help_image_cart']              = 'Product image on Cart pages.<br />Default size 47 x 47px';
...
$_['error_image_thumb']            = 'Normal Desktop Thumb Size dimensions required!';
$_['error_image_wide_thumb']       = 'Wide Screen Thumb Size dimensions required!';
