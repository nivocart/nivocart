...
define('HTTP_NIVOCART', $protocol . $_SERVER['HTTP_HOST'] . rtrim(rtrim(dirname($_SERVER['SCRIPT_NAME']), 'install'), '/.\\') . '/');
...
if (file_exists('../config.php')) {
	if (filesize('../config.php') > 0) {
		...
		$subject = file_get_contents(DIR_NIVOCART . 'config.php');
