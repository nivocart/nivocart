...
<?php } ?>
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" name="install">
	...
	<p id="progress" class="animated fadeIn" style="display:none;"><?php echo $text_is_installing; ?></p>
    </fieldset>
    <div id="start" class="buttons">
      ...
      <div class="right"><input type="submit" value="<?php echo $button_install; ?>" class="button animated fadeIn" onclick="return progress();" /></div>
    </div>
  </form>
</div>
