...
abstract class AbstractFrameDecorator extends Frame {
	 ...
	 * @param int $value
	 */
	public function reset_counter($id = self::DEFAULT_COUNTER, $value = 0): void {
	 ...
	 * @param $counters
	 */
	public function decrement_counters($counters): void {
	 ...
	 * @param $counters
	 */
	public function increment_counters($counters): void {
		foreach ($counters as $id => $increment) {
	 ...
	 * @param int $increment
	 */
	public function increment_counter($id = self::DEFAULT_COUNTER, $increment = 1): void {
