...
class Style {
	 ...
	 * @var array
	 */
	public static $vertical_align_keywords = ["baseline", "bottom", "middle", "sub", "super", "text-bottom", "text-top", "top"];
	 ...
	 * @var array
	 */
	public static $BORDER_STYLES = ["none", "hidden", "dotted", "dashed", "solid", "double", "groove", "ridge", "inset", "outset"];
	 ...
	 * @param $media_queries
	 */
	public function set_media_queries($media_queries): void {
	...
	public function merge(Style $style): void {
		...
		foreach ($style->_props as $prop => $val) {
			...
			if ($can_merge) {
				...
				$shorthands = array_filter($shorthand_properties, fn ($el) => (str_contains($prop, $el . "_")));
	 ...
	 */
	public function important_set($prop): void {
	...
	public function computed_bottom_spacing() {
		...
		return $this->_computed_bottom_spacing = $this->length_in_pt([$this->margin_bottom, $this->padding_bottom, $this->border_bottom_width]);
	}
	...
	*/
	 ...
	 * @param $important
	 */
	protected function _set_style_side_type($style, $side, $type, $val, $important): void {
	 ...
	 * @param $important
	 */
	protected function _set_style_sides_type($style, $top, $right, $bottom, $left, $type, $important): void {
	 ...
	 * @param $important
	 */
	protected function _set_style_type($style, $type, $val, $important): void {
		// when rgb() has spaces
	 ...
	 * @param $val
	 */
	protected function _set_style_type_important($style, $type, $val): void {
	 ...
	 * @param $val
	 */
	protected function _set_style_side_width_important($style, $side, $val): void {
		if ($side === "bottom") {
	 ...
	 * @param $important
	 */
	protected function _set_style($style, $val, $important): void {
	 ...
	 * @param string $color
	 */
	public function set_background_color($color): void {
		$col = $this->munge_color($color);
	 ...
	 * @param string $val
	 */
	public function set_background_image($val): void {
		// see __set and __get, on all assignments clear cache, not needed on direct set through __set
	 ...
	 * @param string $val
	 */
	public function set_background_repeat($val): void {
		if (is_null($val)) {
	 ...
	 * @param string $val
	 */
	public function set_background_attachment($val): void {
		if (is_null($val)) {
	 ...
	 * @param string $val
	 */
	public function set_background_position($val): void {
		if (is_null($val)) {
	 ...
	 * @param string $val
	 */
	public function set_background($val): void {
		$val = trim($val);
	 ...
	 * @param $val
	 */
	public function set_font($val): void {
		$this->__font_size_calculated = false;
		// see __set and __get, on all assignments clear cache, not needed on direct set through __set
	 ...
	 * @param string $break
	 */
	public function set_page_break_before($break): void {
	 ...
	 * @param $break
	 */
	public function set_page_break_after($break): void {
		if ($break === "left" || $break === "right") {
			$break = "always";
		}
	 ...
	 * @param $val
	 */
	public function set_margin_top($val): void {
	 ...
	 * @param $val
	 */
	public function set_margin_right($val): void {
	 ...
	 * @param $val
	 */
	public function set_margin_bottom($val): void {
	 ...
	 * @param $val
	 */
	public function set_margin_left($val): void {
	 ...
	 * @param $val
	 */
	public function set_margin($val): void {
	 ...
	 * @param $val
	 */
	public function set_padding_top($val): void {
	 ...
	 * @param $val
	 */
	public function set_padding_right($val): void {
	 ...
	 * @param $val
	 */
	public function set_padding_bottom($val): void {
	 ...
	 * @param $val
	 */
	public function set_padding_left($val): void {
	 ...
	 * @param $val
	 */
	public function set_padding($val): void {
		$val = str_replace("none", "0px", $val);
	 ...
	 */
	protected function _set_border($side, $border_spec, $important): void {
	 ...
	 * @param string $val
	 */
	public function set_border_top($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_right($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_bottom($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_left($val): void {
	 ...
	 * @param $val
	 */
	public function set_border($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_width($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_color($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_style($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_top_left_radius($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_top_right_radius($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_bottom_left_radius($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_bottom_right_radius($val): void {
	 ...
	 * @param $val
	 */
	public function set_border_radius($val): void {
	 ...
	 * @param $val4
	 */
	protected function _set_border_radii($val1, $val2, $val3, $val4): void {
	 ...
	 * @param $corner
	 */
	protected function _set_border_radius_corner($val, $corner): void {
	 ...
	 * @param string $val
	 */
	public function set_outline($val): void {
	 ...
	 * @param $val
	 */
	public function set_outline_width($val): void {
	 ...
	 * @param $val
	 */
	public function set_outline_color($val): void {
	 ...
	 * @param $val
	 */
	public function set_outline_style($val): void {
	 ...
	 * @param float $val
	 */
	public function set_border_spacing($val): void {
		$arr = explode(" ", $val);
	 ...
	 * @param $val
	 */
	public function set_list_style_image($val): void {
		// see __set and __get, on all assignments clear cache, not needed on direct set through __set
	 ...
	 * @param $val
	 */
	public function set_list_style($val): void {
	 ...
	 * @param $val
	 */
	public function set_size($val): void {
	 ...
	 * @param $val
	 */
	public function set_transform($val): void {
		// see __set and __get, on all assignments clear cache, not needed on direct set through __set
	 ...
	 * @param $val
	 */
	public function set__webkit_transform($val): void {
	 ...
	 * @param $val
	 */
	public function set__webkit_transform_origin($val): void {
	 ...
	 * @param string $val
	 */
	public function set_transform_origin($val): void {
		// see __set and __get, on all assignments clear cache, not needed on direct set through __set
	 ...
	 * @param $val
	 */
	public function set_background_image_resolution($val): void {
	 ...
	 * @param $val
	 */
	public function set_image_resolution($val): void {
		$parsed = $this->parse_image_resolution($val);
	 ...
	 * @param $val
	 */
	public function set__dompdf_background_image_resolution($val): void {
	 ...
	 * @param $val
	 */
	public function set__dompdf_image_resolution($val): void {
	 ...
	 * @param $val
	 */
	public function set_z_index($val): void {
	 ...
	 * @param $val
	 */
	public function set_counter_increment($val): void {
		$val = trim($val);
		$value = null;
	...
	public function __toString() {
		return print_r(array_merge(["parent_font_size" => $this->_parent_font_size], $this->_props), true);
	}
