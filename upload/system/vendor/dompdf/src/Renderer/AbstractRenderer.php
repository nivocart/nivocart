...
abstract class AbstractRenderer {
	 ...
	 * @throws \Exception
	 */
	protected function _background_image($url, $x, $y, $width, $height, $style): void {
	 ...
	 * @param int $r2
	 */
	protected function _border_none($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
		return;
	}
	 ...
	 * @param int $r2
	 */
	protected function _border_hidden($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
		return;
	}
	 ...
	 * @param int $r2
	 */
	protected function _border_dotted($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
	 ...
	 * @param int $r2
	 */
	protected function _border_dashed($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
	 ...
	 * @param int $r2
	 */
	protected function _border_solid($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
	 ...
	 * @param $r2
	 */
	protected function _apply_ratio($side, $ratio, $top, $right, $bottom, $left, &$x, &$y, &$length, &$r1, &$r2): void {
		switch ($side) {
			case "top":
				$r1 -= $left * $ratio;
				$r2 -= $right * $ratio;
	 ...
	 * @param int $r2
	 */
	protected function _border_double($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
		[$top, $right, $bottom, $left] = $widths;
	 ...
	 * @param int $r2
	 */
	protected function _border_groove($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
		[$top, $right, $bottom, $left] = $widths;
	 ...
	 * @param int $r2
	 */
	protected function _border_ridge($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
		[$top, $right, $bottom, $left] = $widths;
	 ...
	 * @param int $r2
	 */
	protected function _border_inset($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
		switch ($side) {
			case "top":
			case "left":
	 ...
	 * @param int $r2
	 */
	protected function _border_outset($x, $y, $length, $color, $widths, $side, $corner_style = "bevel", $r1 = 0, $r2 = 0): void {
		switch ($side) {
			case "top":
			case "left":
				$tint = array_map([$this, "_tint"], $color);
	 ...
	 * @var $top
	 */
	protected function _border_line($x, $y, $length, $color, $widths, $side, $corner_style, $pattern_name, $r1 = 0, $r2 = 0): void {
		/** used by $$side */
		[$top, $right, $bottom, $left] = $widths;
	 ...
	 * @param $opacity
	 */
	protected function _set_opacity($opacity): void {
	 ...
	 * @param array $style
	 */
	protected function _debug_layout($box, $color = "red", $style = []): void {
