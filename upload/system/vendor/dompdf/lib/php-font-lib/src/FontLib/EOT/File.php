...
class File extends \FontLib\TrueType\File {
	public const TTEMBED_SUBSET = 0x00000001;
	public const TTEMBED_TTCOMPRESSED = 0x00000004;
	public const TTEMBED_FAILIFVARIATIONSIMULATED = 0x00000010;
	public const TTMBED_EMBEDEUDC = 0x00000020;
	public const TTEMBED_VALIDATIONTESTS = 0x00000040; // Deprecated
	public const TTEMBED_WEBOBJECT = 0x00000080;
	public const TTEMBED_XORENCRYPTDATA = 0x10000000;
