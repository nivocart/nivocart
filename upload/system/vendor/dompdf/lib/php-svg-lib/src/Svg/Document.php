...
class Document extends AbstractTag {
	...
	protected function initParser() {
		...
		xml_set_element_handler($parser, [$this, "_tagStart"], [$this, "_tagEnd"]);
	...
	public function getDimensions() {
		...
		xml_set_element_handler(
			$parser,
			function ($parser, $name, $attributes) use (&$rootAttributes): void {
	 ...
	 * @param
	 */
	public function appendStyleSheet($stylesheet): void {
	...
	protected function svgOffset($attributes): void {
	...
	private function _tagStart($parser, $name, $attributes): void {
		$this->x = 0;
		$this->y = 0;
	...
	public function _charData($parser, $data): void {
	...
	public function _tagEnd($parser, $name): void {
		$tag = null;
