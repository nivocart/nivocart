...
class SurfaceCpdf implements SurfaceInterface {
	...
	public function scale($x, $y): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function fillText($text, $x, $y, $maxWidth = null): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function strokeText($text, $x, $y, $maxWidth = null): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function drawImage($image, $sx, $sy, $sw = null, $sh = null, $dx = null, $dy = null, $dw = null, $dh = null): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function quadraticCurveTo($cpx, $cpy, $x, $y): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
		// not accurate
	...
	public function arc($x, $y, $radius, $startAngle, $endAngle, $anticlockwise = false): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function circle($x, $y, $radius): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function ellipse($x, $y, $radiusX, $radiusY, $rotation, $startAngle, $endAngle, $anticlockwise): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function rect($x, $y, $w, $h, $rx = 0, $ry = 0): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function strokeRect($x, $y, $w, $h): void {
		if (self::DEBUG) {
			echo __FUNCTION__ . "\n";
		}
	...
	public function setStyle(Style $style): void {
		...
		if ($stroke = $style->stroke) {
			$canvas->setStrokeColor([$stroke[0] / 255, $stroke[1] / 255, $stroke[2] / 255], true);
		}

		if ($fill = $style->fill) {
			$canvas->setColor([$fill[0] / 255, $fill[1] / 255, $fill[2] / 255], true);
		}
	...
	public function setFont($family, $style, $weight): void {
		$map = [
			"serif" => "Times",
