...
class Style {
	...
	public function fromStyleSheets(AbstractTag $tag, $attributes): void {
	...
	protected function fillStyles($styles): void {
	...
	public static function getTriplet($color, $percent = false) {
		$i = strpos($color, "(");
		$j = strpos($color, ")");
	...
	public static function parseHexColor($hex) {
		$c = [0, 0, 0];
	 ...
	 * @return array
	 */
	public static function parseCssStyle($style) {
		$matches = [];
	 ...
	 * @return float|null
	 */
	public static function convertSize($size, $referenceSize = 11.0, $dpi = 96.0) {
