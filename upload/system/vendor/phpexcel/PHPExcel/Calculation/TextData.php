...
class PHPExcel_Calculation_TextData {
	...
	public static function TRIMNONPRINTABLE($stringValue = '') {
		...
		if (is_string($stringValue) || is_numeric($stringValue)) {
			return str_replace(self::$_invalidChars, '', trim((string) $stringValue, "\x00..\x1F"));
		}
	...
	public static function VALUE($value = '') {
		...
		if (!is_numeric($value)) {
			$numberValue = str_replace(PHPExcel_Shared_String::getThousandsSeparator(), '', trim((string) $value, " \t\n\r\0\x0B" . PHPExcel_Shared_String::getCurrencyCode()));
