...
class PHPExcel_Style_NumberFormat extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable {
	...
	private static function _formatAsDate(&$value, &$format): void {
	...
	private static function _formatAsPercentage(&$value, &$format): void {
	...
	private static function _formatAsFraction(&$value, &$format): void {
		$sign = ($value < 0) ? '-' : '';
