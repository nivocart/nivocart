...
class PHPExcel_Reader_HTML extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader {
	...
	protected function _flushCell($sheet, $column, $row, &$cellContent): void {
	...
	protected function _processDomElement(DOMNode $element, $sheet, &$row, &$column, &$cellContent, $format = null): void {
