...
class PHPExcel_CachedObjectStorageFactory {
	public const CACHEINMEMORY = 'Memory';
	public const CACHEINMEMORYGZIP = 'MemoryGZip';
	public const CACHEINMEMORYSERIALIZED = 'MemorySerialized';
	public const CACHEIGBINARY = 'Igbinary';
	public const CACHETODISCISAM = 'DiscISAM';
	public const CACHETOAPC = 'APC';
	public const CACHETOMEMCACHE = 'Memcache';
	public const CACHETOPHPTEMP = 'PHPTemp';
	public const CACHETOWINCACHE = 'Wincache';
	public const CACHETOSQLITE = 'SQLite';
	public const CACHETOSQLITE3 = 'SQLite3';
	 ...
	 *
	 * @return PHPExcel_CachedObjectStorage_ICache|false
	 **/
