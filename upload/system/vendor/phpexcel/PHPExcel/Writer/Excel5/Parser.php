...
class PHPExcel_Writer_Excel5_Parser {
	 ...
	 * @access private
	 */
	public function _initializeHashes(): void {
	...
	public function _advance() {
		...
		$formula_length = strlen((string) $this->_formula);
		// eat up white spaces
		if ($i < $formula_length) {
	...
	public function _match($token) {
		switch ($token) {
			...
			default:
				...
				if (preg_match('/^\$?[A-Ia-i]?[A-Za-z]\$?[0-9]+$/', (string) $token) and !preg_match("/[0-9]/", (string) $this->_lookahead) and ($this->_lookahead != ':') and ($this->_lookahead != '.') and ($this->_lookahead != '!')) {
					return $token;
				} elseif (preg_match("/^" . self::REGEX_SHEET_TITLE_UNQUOTED . "(\:" . self::REGEX_SHEET_TITLE_UNQUOTED . ")?\!\\$?[A-Ia-i]?[A-Za-z]\\$?[0-9]+$/u", (string) $token) and !preg_match("/[0-9]/", (string) $this->_lookahead) and ($this->_lookahead != ':') and ($this->_lookahead != '.')) {
					return $token;
				} elseif (preg_match("/^'" . self::REGEX_SHEET_TITLE_QUOTED . "(\:" . self::REGEX_SHEET_TITLE_QUOTED . ")?'\!\\$?[A-Ia-i]?[A-Za-z]\\$?[0-9]+$/u", (string) $token) and !preg_match("/[0-9]/", (string) $this->_lookahead) and ($this->_lookahead != ':') and ($this->_lookahead != '.')) {
					return $token;
				} elseif (preg_match('/^(\$)?[A-Ia-i]?[A-Za-z](\$)?[0-9]+:(\$)?[A-Ia-i]?[A-Za-z](\$)?[0-9]+$/', (string) $token) and !preg_match("/[0-9]/", (string) $this->_lookahead)) {
					return $token;
				} elseif (preg_match("/^" . self::REGEX_SHEET_TITLE_UNQUOTED . "(\:" . self::REGEX_SHEET_TITLE_UNQUOTED . ")?\!\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+:\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+$/u", (string) $token) and !preg_match("/[0-9]/", (string) $this->_lookahead)) {
					return $token;
				} elseif (preg_match("/^'" . self::REGEX_SHEET_TITLE_QUOTED . "(\:" . self::REGEX_SHEET_TITLE_QUOTED . ")?'\!\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+:\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+$/u", (string) $token) and !preg_match("/[0-9]/", (string) $this->_lookahead)) {
					return $token;
	...
	public function _expression() {
		...
		if (preg_match("/\"([^\"]|\"\"){0,255}\"/", (string) $this->_current_token)) {
		...
		} elseif (preg_match("/^#[A-Z0\/]{3,5}[!?]{1}$/", (string) $this->_current_token) or $this->_current_token == '#N/A') {
	...
	public function _fact() {
		...
		// if it's a reference
		if (preg_match('/^\$?[A-Ia-i]?[A-Za-z]\$?[0-9]+$/', (string) $this->_current_token)) {
			$result = $this->_createTree($this->_current_token, '', '');
			$this->_advance();
			return $result;
		} elseif (preg_match("/^" . self::REGEX_SHEET_TITLE_UNQUOTED . "(\:" . self::REGEX_SHEET_TITLE_UNQUOTED . ")?\!\\$?[A-Ia-i]?[A-Za-z]\\$?[0-9]+$/u", (string) $this->_current_token)) {
			$result = $this->_createTree($this->_current_token, '', '');
			$this->_advance();
			return $result;
		} elseif (preg_match("/^'" . self::REGEX_SHEET_TITLE_QUOTED . "(\:" . self::REGEX_SHEET_TITLE_QUOTED . ")?'\!\\$?[A-Ia-i]?[A-Za-z]\\$?[0-9]+$/u", (string) $this->_current_token)) {
			$result = $this->_createTree($this->_current_token, '', '');
			$this->_advance();
			return $result;
		} elseif (preg_match('/^(\$)?[A-Ia-i]?[A-Za-z](\$)?[0-9]+:(\$)?[A-Ia-i]?[A-Za-z](\$)?[0-9]+$/', (string) $this->_current_token) or preg_match('/^(\$)?[A-Ia-i]?[A-Za-z](\$)?[0-9]+\.\.(\$)?[A-Ia-i]?[A-Za-z](\$)?[0-9]+$/', (string) $this->_current_token)) {
			// must be an error?
			$result = $this->_createTree($this->_current_token, '', '');
			$this->_advance();
			return $result;
		} elseif (preg_match("/^" . self::REGEX_SHEET_TITLE_UNQUOTED . "(\:" . self::REGEX_SHEET_TITLE_UNQUOTED . ")?\!\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+:\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+$/u", (string) $this->_current_token)) {
			// must be an error?
			//$result = $this->_current_token;
			$result = $this->_createTree($this->_current_token, '', '');
			$this->_advance();
			return $result;
		} elseif (preg_match("/^'" . self::REGEX_SHEET_TITLE_QUOTED . "(\:" . self::REGEX_SHEET_TITLE_QUOTED . ")?'\!\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+:\\$?([A-Ia-i]?[A-Za-z])?\\$?[0-9]+$/u", (string) $this->_current_token)) {
			// must be an error?
			//$result = $this->_current_token;
			$result = $this->_createTree($this->_current_token, '', '');
			$this->_advance();
			...
			$this->_advance();
			return $result;
		} elseif (preg_match("/^[A-Z0-9\xc0-\xdc\.]+$/i", (string) $this->_current_token)) {
			$result = $this->_func();
			return $result;
		}
	...
	public function _func() {
		...
		$function = strtoupper((string) $this->_current_token);
	...
	public function toReversePolish($tree = []) {
		...
		if (preg_match("/^[A-Z0-9\xc0-\xdc\.]+$/", (string) $tree['value']) and !preg_match('/^([A-Ia-i]?[A-Za-z])(\d+)$/', (string) $tree['value']) and !preg_match("/^[A-Ia-i]?[A-Za-z](\d+)\.\.[A-Ia-i]?[A-Za-z](\d+)$/", (string) $tree['value']) and !is_numeric($tree['value']) and !isset($this->ptg[$tree['value']])) {
