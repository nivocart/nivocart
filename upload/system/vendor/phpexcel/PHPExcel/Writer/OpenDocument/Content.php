...
class PHPExcel_Writer_OpenDocument_Content extends PHPExcel_Writer_OpenDocument_WriterPart {
	 ...
	 */
	private function _writeSheets(PHPExcel_Shared_XMLWriter $objWriter): void {
		$pPHPExcel = $this->getParentWriter()->getPHPExcel(); /* @var $pPHPExcel PHPExcel */
	 ...
	 */
	private function _writeRows(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet $sheet): void {
	 ...
	 * @throws PHPExcel_Writer_Exception
	 */
	private function _writeCells(PHPExcel_Shared_XMLWriter $objWriter, PHPExcel_Worksheet_Row $row): void {
	 ...
	 */
	private function _writeCellSpan(PHPExcel_Shared_XMLWriter $objWriter, $curColumn, $prevColumn): void {
