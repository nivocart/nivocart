...
class PHPExcel_Writer_Excel2007_Workbook extends PHPExcel_Writer_Excel2007_WriterPart {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeFileVersion(PHPExcel_Shared_XMLWriter $objWriter = null): void {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeWorkbookPr(PHPExcel_Shared_XMLWriter $objWriter = null): void {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeBookViews(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null): void {
		// bookViews
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeWorkbookProtection(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null): void {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeCalcPr(PHPExcel_Shared_XMLWriter $objWriter = null, $recalcRequired = true): void {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeSheets(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null): void {
		// Write sheets
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeSheet(PHPExcel_Shared_XMLWriter $objWriter = null, $pSheetname = '', $pSheetId = 1, $pRelId = 1, $sheetState = 'visible'): void {
		if ($pSheetname !== '') {
			// Write sheet
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNames(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel $pPHPExcel = null): void {
		// Write defined names
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeNamedRanges(PHPExcel_Shared_XMLWriter $objWriter = null, ?PHPExcel $pPHPExcel = null): void {
		// Loop named ranges
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForNamedRange(PHPExcel_Shared_XMLWriter $objWriter = null, ?PHPExcel_NamedRange $pNamedRange = null): void {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForAutofilter(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, $pSheetId = 0): void {
		// definedName for autoFilter
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForPrintTitles(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, $pSheetId = 0): void {
	 ...
	 * @throws 	PHPExcel_Writer_Exception
	 */
	private function _writeDefinedNameForPrintArea(PHPExcel_Shared_XMLWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, $pSheetId = 0): void {
