...
class PHPExcel_Writer_Excel2007_Chart extends PHPExcel_Writer_Excel2007_WriterPart {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writeTitle(PHPExcel_Chart_Title $title = null, $objWriter = null): void {
		if (is_null($title)) {
			return;
		}
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writeLegend(PHPExcel_Chart_Legend $legend = null, $objWriter = null): void {
		if (is_null($legend)) {
			return;
		}
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writeDataLbls($objWriter, $chartLayout): void {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writeCatAx($objWriter, PHPExcel_Chart_PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis): void {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writeValAx($objWriter, PHPExcel_Chart_PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries, $xAxis, $yAxis, $majorGridlines, $minorGridlines): void {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writePlotGroup($plotGroup, $groupType, $objWriter, &$catIsMultiLevelSeries, &$valIsMultiLevelSeries, &$plotGroupingType, PHPExcel_Worksheet $pSheet): void {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writePlotSeriesLabel($plotSeriesLabel, $objWriter): void {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writePlotSeriesValues($plotSeriesValues, $objWriter, $groupType, $dataType = 'str', ?PHPExcel_Worksheet $pSheet = null): void {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writeBubbles($plotSeriesValues, $objWriter, PHPExcel_Worksheet $pSheet): void {
		if (is_null($plotSeriesValues)) {
			return;
		}
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writeLayout(PHPExcel_Chart_Layout $layout = null, $objWriter = null): void {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writeAlternateContent($objWriter): void {
	 ...
	 * @throws  PHPExcel_Writer_Exception
	 */
	private function _writePrintSettings($objWriter): void {
