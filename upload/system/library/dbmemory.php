 ...
 * ----------------------
 * - It wraps the real database object ($this->db).
 ...
 * - If the same SEO URL query fires multiple times per page load (e.g. in a loop or across multiple components), this will genuinely save repeated DB round trips.
 *
