...
Read the instructions below before you create a bug report.
 ...
 1. Ask the community if they have seen the bug or know how to fix it.
...
- If you would like to report a security bug please do one of the following: PM a forum moderator (Admin), or better, use the contact form on the [NivoCart website](https://nivocart.org/contact).
